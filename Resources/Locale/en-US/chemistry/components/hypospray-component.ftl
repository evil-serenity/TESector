...
## Jet Injectors
hypospray-component-injecting-user = You start preparing the hypodermic spray on the skin.
hypospray-component-injecting-target = {CAPITALIZE(THE($user))} is trying to prepare a hypodermic spray on you!
