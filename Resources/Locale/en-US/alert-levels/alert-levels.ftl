...
alert-level-green-announcement = The Station is now considered safe, return to operations as normal.
alert-level-green-instructions = Do your job.
...
alert-level-blue-announcement = There is a confirmed threat to the station. Crews are advised to be vigilant and report suspicious activity to security officers.
alert-level-blue-instructions = Crews are advised to be vigilant and report suspicious activity to security officers.
...
# alert-level-violet-announcement = There is a medical emergency on the station. Medical staff are advised to isolate crewmembers with any symptoms. Crewmembers are advised to distance themselves from others and perform safety measures to prevent further spread.
...
alert-level-violet-announcement = There is a medical emergency in the sector. Medical staff are advised to isolate individuals showing symptoms. Crews are advised to limit interaction with others and enforce safety measures to prevent further spread.
...
alert-level-yellow-announcement = Station infrastructure has been structurally or atmospherically compromised. Engineering staff are advised to immediately respond and assist where possible. Crews are advised to stay away from the threat and cooperate with station command.
...
alert-level-gamma-announcement = Colonial Command has ordered the Gamma security level in the sector. Security officers are to be on high alert, and crews are to avoid areas of conflict where possible.
...
alert-level-delta-announcement = Station infrastructure is currently under threat of imminent destruction. Crews are advised to listen to sector command for more information.
