...
namespace Content.Shared.Cybernetics
{
    public sealed class SyndieOmniHandSystem : EntitySystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<SyndieOmniHandComponent, SyndieOmniHandToggledEvent>(OnSyndieOmniHandToggled);

            SubscribeLocalEvent<SyndieOmniHandComponent, ComponentStartup>(OnStartup);
        ...
        private void OnStartup(EntityUid uid, SyndieOmniHandComponent component, ComponentStartup args)
        {
            _actions.AddAction(uid, ref component.Action, component.ActionPrototype);
        }

        private void OnShutdown(EntityUid uid, SyndieOmniHandComponent component, ComponentShutdown args)
        {
