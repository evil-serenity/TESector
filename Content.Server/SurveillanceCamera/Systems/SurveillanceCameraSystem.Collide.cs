...
public partial class SurveillanceCameraSystem
{
    ...
    // [Dependency] private readonly EntityQuery<CameraActiveOnCollideComponent> _cameraQuery = default!; // HardLight: Revert comment when Predict EMP #39802 is ported.
    private EntityQuery<CameraActiveOnCollideComponent> _cameraQuery; // HardLight: Remove when Predict EMP #39802 is ported.

    public void InitializeCollide()
    {
        _cameraQuery = GetEntityQuery<CameraActiveOnCollideComponent>(); // HardLight: Remove when Predict EMP #39802 is ported.
