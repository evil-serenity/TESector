...
public sealed class SiliconDeathSystem : EntitySystem
{
    ...
    private void SiliconDead(EntityUid uid, SiliconDownOnDeadComponent siliconDeadComp, BatteryComponent? batteryComp, EntityUid batteryUid)
    {
        ...
        EntityManager.EnsureComponent<ForcedSleepingStatusEffectComponent>(uid); // HardLight: ForcedSleepingComponent<ForcedSleepingStatusEffectComponent

        if (TryComp(uid, out HumanoidAppearanceComponent? humanoidAppearanceComponent))
        {
            var layers = HumanoidVisualLayersExtension.Sublayers(HumanoidVisualLayers.HeadSide);
            _humanoidAppearanceSystem.SetLayersVisibility(uid, layers, visible: true);
        }
    ...
    {
        RemComp<ForcedSleepingStatusEffectComponent>(uid); // HardLight: ForcedSleepingComponent<ForcedSleepingStatusEffectComponent
