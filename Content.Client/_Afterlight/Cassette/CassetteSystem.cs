using Content.Shared._Afterlight.Cassette;
...
namespace Content.Client._Afterlight.Cassette;
...
public sealed class CassetteSystem : SharedCassetteSystem
{
    ...
    protected override async void ChooseCustomTrack(Entity<CassetteTapeComponent> tape)
    {
        try
        {
            ...
            var name = $"/Audio/_Afterlight/_CustomCassetteUploads/upload_{_names.Count}.ogg";
