using Content.Client.Stylesheets; // HardLight: .Stylesheets.Palette<.Stylesheets; undo if we port upstream's #29903.
...
{
    private static readonly Color SelectedOptionColor = StyleNano.ButtonColorGoodDefault.WithAlpha(128); // HardLight: Palettes.Green.Element<StyleNano.ButtonColorGoodDefault; undo if we port upstream's #29903.
    private static readonly Color SelectedOptionHoverColor = StyleNano.ButtonColorGoodHovered.WithAlpha(128); // HardLight: Palettes.Green.HoveredElement<StyleNano.ButtonColorGoodHovered; undo if we port upstream's #29903.
